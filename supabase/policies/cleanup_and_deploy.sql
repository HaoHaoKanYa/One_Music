...
-- 删除所有现有策略
DROP POLICY IF EXISTS "Users can view public profiles or own profile" ON user_profiles;
DROP POLICY IF EXISTS "Users can update own profile" ON user_profiles;
DROP POLICY IF EXISTS "Users can insert own profile" ON user_profiles;

DROP POLICY IF EXISTS "Users can view own favorite songs" ON favorite_songs;
DROP POLICY IF EXISTS "Users can add own favorite songs" ON favorite_songs;
DROP POLICY IF EXISTS "Users can delete own favorite songs" ON favorite_songs;

DROP POLICY IF EXISTS "Users can view own play history" ON play_history;
DROP POLICY IF EXISTS "Users can add own play history" ON play_history;
DROP POLICY IF EXISTS "Users can delete own play history" ON play_history;
...
DROP POLICY IF EXISTS "Users can add songs to own playlists" ON playlist_songs;
DROP POLICY IF EXISTS "Users can delete songs from own playlists" ON playlist_songs;

DROP POLICY IF EXISTS "Users can view own disliked songs" ON disliked_songs;
DROP POLICY IF EXISTS "Users can add own disliked songs" ON disliked_songs;
DROP POLICY IF EXISTS "Users can delete own disliked songs" ON disliked_songs;
