...
export default memo(() => {
  ...
  return (
    <Section title={t('setting_about')}>
      ...
      <View style={styles.part}>
        <Text style={styles.text}><Text style={styles.boldText}>One Music 完全免费且开源</Text>，如果您是付费购买的，请立即申请退款并给予差评！</Text>
      </View>
      <View style={styles.part}>
        <Text style={styles.text}>本软件基于开源项目进行二次开发，致力于为用户提供优质的音乐播放体验，软件将始终保持纯净无广告。</Text>
      </View>
      <View style={styles.part}>
        <Text style={styles.text}>目前本项目的原始发布地址<Text style={styles.boldText}>只有 GitHub</Text> (https://github.com/HaoHaoKanYa/One_Music)，其他渠道均为第三方转载发布，可信度请自行鉴别。</Text>
      </View>
      <View style={styles.part}>
        <Text style={styles.text}><Text style={styles.boldText}>本项目没有微信公众号之类的所谓「官方账号」，也未在小米、华为、vivo 等应用商店发布应用，商店内的「One Music」相关应用全部属于假冒应用，请谨防被骗！</Text></Text>
      </View>
      <View style={styles.part}>
        <Text style={styles.text}>若您使用过程中遇到<Text style={styles.boldText}>广告</Text>或<Text style={styles.boldText}>引流</Text>（如需要加群、关注公众号之类才能使用或升级）的信息，则表明您当前运行的软件是「第三方修改版」。</Text>
      </View>
      <View style={styles.part}>
        <Text style={styles.text}>若在升级新版本时提示「<Text style={styles.boldText}>签名不一致</Text>」，则表明您手机上的旧版本或将要安装的新版本中<Text style={styles.boldText}>有一方</Text>是「<Text style={styles.boldText}>第三方修改版</Text>」。</Text>
      </View>
      <View style={styles.part}>
